 ...
 * <li>
 * <em>Removed all references to System dot out, System dot err, and the like.</em>
...
public class Base64 {
        ...
        public void write(int theByte) throws java.io.IOException {
            ...
            // Else, Decoding
                ...
                if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    throw new java.io.IOException(
                            "Invalid character in Base64 data: " + theByte);
    ...
    public static char[] encodeBytesToCharArray(byte [] source) {
    	 byte b64b[] =Base64.encodeBytesToBytes(source);
	       char b64c[] = new char[b64b.length];
	       for (int i=0; i<b64b.length; i++) {
	    	   b64c[i]=(char) b64b[i];
	       }
	       return b64c;
    }
